...
/**
 * Renderer for Shadow Villager - Dark End dimension variant.
 */
public class ShadowVillagerRenderer extends VillagerRenderer {
    private static final String BASE_PATH = "textures/entity/villager/shadow_villager/";

    public ShadowVillagerRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
