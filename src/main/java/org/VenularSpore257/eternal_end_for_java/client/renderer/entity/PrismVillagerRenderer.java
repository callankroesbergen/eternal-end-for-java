...
/**
 * Renderer for Prism Villager - Crystal-infused End dimension variant.
 */
public class PrismVillagerRenderer extends VillagerRenderer {
    private static final String BASE_PATH = "textures/entity/villager/prism_villager/";

    public PrismVillagerRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
