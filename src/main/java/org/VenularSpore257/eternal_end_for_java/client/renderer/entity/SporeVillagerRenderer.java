...
/**
 * Renderer for Spore Villager - Fungal End dimension variant.
 */
public class SporeVillagerRenderer extends VillagerRenderer {
    private static final String BASE_PATH = "textures/entity/villager/spore_villager/";

    public SporeVillagerRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
